...
def create_app(test_config=None):
	...
	## Graph comparison
    from pbshm.graphcomparison import graphcomparison
    app.register_blueprint(graphcomparison.bp, url_prefix="/graphcomparison")
